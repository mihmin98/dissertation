...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_1_layers.eps}
        \caption{Training results with 1 layer of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_3_layers.eps}
        \caption{Training results with 3 layers of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_5_layers.eps}
        \caption{Training results with 5 layers of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_7_layers.eps}
        \caption{Training results with 7 layers of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_128_1_layers.eps}
        \caption{Training results with 1 layer of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_128_3_layers.eps}
        \caption{Training results with 3 layers of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_128_5_layers.eps}
        \caption{Training results with 5 layers of units}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\linewidth]{shoot_moving_target_128_7_layers.eps}
        \caption{Training results with 7 layers of units}
